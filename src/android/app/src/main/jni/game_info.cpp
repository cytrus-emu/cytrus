...
JNIEXPORT jlong JNICALL Java_org_cytrus_cytrus_1emu_model_GameInfo_initialize(JNIEnv* env, jclass,
                                                                              jstring j_path) {
...
JNIEXPORT void JNICALL Java_org_cytrus_cytrus_1emu_model_GameInfo_finalize(JNIEnv* env,
                                                                           jobject obj) {
    delete GetPointer(env, obj);
}

jstring Java_org_cytrus_cytrus_1emu_model_GameInfo_getTitle(JNIEnv* env, jobject obj) {
...
jstring Java_org_cytrus_cytrus_1emu_model_GameInfo_getCompany(JNIEnv* env, jobject obj) {
    Loader::SMDH* smdh = GetPointer(env, obj);
    Loader::SMDH::TitleLanguage language = Loader::SMDH::TitleLanguage::English;
...
jstring Java_org_cytrus_cytrus_1emu_model_GameInfo_getRegions(JNIEnv* env, jobject obj) {
    Loader::SMDH* smdh = GetPointer(env, obj);
...
jintArray Java_org_cytrus_cytrus_1emu_model_GameInfo_getIcon(JNIEnv* env, jobject obj) {
    Loader::SMDH* smdh = GetPointer(env, obj);
...
jboolean Java_org_cytrus_cytrus_1emu_model_GameInfo_getIsVisibleSystemTitle(JNIEnv* env,
                                                                            jobject obj) {
    Loader::SMDH* smdh = GetPointer(env, obj);
    if (smdh == nullptr) {
        return false;
