...
JNIEXPORT void JNICALL Java_org_cytrus_cytrus_1emu_features_cheats_model_CheatEngine_loadCheatFile(
    JNIEnv* env, jclass, jlong title_id) {
    GetEngine().LoadCheatFile(title_id);
}

JNIEXPORT void JNICALL Java_org_cytrus_cytrus_1emu_features_cheats_model_CheatEngine_saveCheatFile(
    JNIEnv* env, jclass, jlong title_id) {
    GetEngine().SaveCheatFile(title_id);
}

JNIEXPORT jobjectArray JNICALL
Java_org_cytrus_cytrus_1emu_features_cheats_model_CheatEngine_getCheats(JNIEnv* env, jclass) {
...
JNIEXPORT void JNICALL Java_org_cytrus_cytrus_1emu_features_cheats_model_CheatEngine_addCheat(
    JNIEnv* env, jclass, jobject j_cheat) {
    auto cheat = *CheatFromJava(env, j_cheat);
    GetEngine().AddCheat(std::move(cheat));
}

JNIEXPORT void JNICALL Java_org_cytrus_cytrus_1emu_features_cheats_model_CheatEngine_removeCheat(
    JNIEnv* env, jclass, jint index) {
    GetEngine().RemoveCheat(index);
}

JNIEXPORT void JNICALL Java_org_cytrus_cytrus_1emu_features_cheats_model_CheatEngine_updateCheat(
