...
#if defined(ENABLE_VULKAN) && CYTRUS_ARCH(arm64)
...
static jobject ToJavaCoreError(Core::System::ResultStatus result) {
    ...
    return env->GetStaticObjectField(
        core_error_class, env->GetStaticFieldID(core_error_class, name,
                                                "Lorg/cytrus/cytrus_emu/NativeLibrary$CoreError;"));
}
...
static Core::System::ResultStatus RunCytrus(const std::string& filepath) {
    // Cytrus core only supports a single running instance
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_surfaceChanged(JNIEnv* env,
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_doFrame([[maybe_unused]] JNIEnv* env,
                                                       [[maybe_unused]] jobject obj) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_notifyOrientationChange([[maybe_unused]] JNIEnv* env,
                                                                       [[maybe_unused]] jobject obj,
                                                                       jint layout_option,
                                                                       jint rotation) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_swapScreens([[maybe_unused]] JNIEnv* env,
                                                           [[maybe_unused]] jobject obj,
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_areKeysAvailable([[maybe_unused]] JNIEnv* env,
                                                                    [[maybe_unused]] jobject obj) {
    HW::AES::InitKeys();
...
jstring Java_org_cytrus_cytrus_1emu_NativeLibrary_getHomeMenuPath(JNIEnv* env,
                                                                  [[maybe_unused]] jobject obj,
                                                                  jint region) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_setUserDirectory(JNIEnv* env,
                                                                [[maybe_unused]] jobject obj,
                                                                jstring j_directory) {
    FileUtil::SetCurrentDir(GetJString(env, j_directory));
}

jobjectArray Java_org_cytrus_cytrus_1emu_NativeLibrary_getInstalledGamePaths(
...
jlongArray Java_org_cytrus_cytrus_1emu_NativeLibrary_getSystemTitleIds(JNIEnv* env,
                                                                       [[maybe_unused]] jobject obj,
                                                                       jint system_type,
                                                                       jint region) {
...
jobject Java_org_cytrus_cytrus_1emu_NativeLibrary_downloadTitleFromNus([[maybe_unused]] JNIEnv* env,
                                                                       [[maybe_unused]] jobject obj,
                                                                       jlong title) {
...
jboolean JNICALL Java_org_cytrus_cytrus_1emu_utils_GpuDriverHelper_supportsCustomDriverLoading(
    JNIEnv* env, jobject instance) {
#ifdef CYTRUS_ARCH_arm64
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_unPauseEmulation([[maybe_unused]] JNIEnv* env,
                                                                [[maybe_unused]] jobject obj) {
    pause_emulation = false;
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_pauseEmulation([[maybe_unused]] JNIEnv* env,
                                                              [[maybe_unused]] jobject obj) {
    pause_emulation = true;
    InputManager::NDKMotionHandler()->DisableSensors();
}

void Java_org_cytrus_cytrus_1emu_NativeLibrary_stopEmulation([[maybe_unused]] JNIEnv* env,
                                                             [[maybe_unused]] jobject obj) {
    stop_run = true;
    pause_emulation = false;
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_isRunning([[maybe_unused]] JNIEnv* env,
                                                             [[maybe_unused]] jobject obj) {
    return static_cast<jboolean>(!stop_run);
}

jlong Java_org_cytrus_cytrus_1emu_NativeLibrary_getRunningTitleId([[maybe_unused]] JNIEnv* env,
                                                                  [[maybe_unused]] jobject obj) {
    u64 title_id{};
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_onGamePadEvent([[maybe_unused]] JNIEnv* env,
                                                                  [[maybe_unused]] jobject obj,
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_onGamePadMoveEvent(
    ...
    // Cytrus uses an inverted y axis sent by the frontend
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_onGamePadAxisEvent(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj, [[maybe_unused]] jstring j_device,
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_onTouchEvent([[maybe_unused]] JNIEnv* env,
                                                                [[maybe_unused]] jobject obj,
                                                                jfloat x, jfloat y,
                                                                jboolean pressed) {
    return static_cast<jboolean>(
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_onTouchMoved([[maybe_unused]] JNIEnv* env,
                                                            [[maybe_unused]] jobject obj, jfloat x,
                                                            jfloat y) {
    window->OnTouchMoved((int)x, (int)y);
}

jlong Java_org_cytrus_cytrus_1emu_NativeLibrary_getTitleId(JNIEnv* env,
                                                           [[maybe_unused]] jobject obj,
                                                           jstring j_filename) {
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_getIsSystemTitle(JNIEnv* env,
                                                                    [[maybe_unused]] jobject obj,
                                                                    jstring path) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_createConfigFile([[maybe_unused]] JNIEnv* env,
                                                                [[maybe_unused]] jobject obj) {
    Config{};
}

void Java_org_cytrus_cytrus_1emu_NativeLibrary_createLogFile([[maybe_unused]] JNIEnv* env,
                                                             [[maybe_unused]] jobject obj) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_logUserDirectory(JNIEnv* env,
                                                                [[maybe_unused]] jobject obj,
                                                                jstring j_path) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_reloadSettings([[maybe_unused]] JNIEnv* env,
                                                              [[maybe_unused]] jobject obj) {
    Config{};
    Core::System& system{Core::System::GetInstance()};
...
jdoubleArray Java_org_cytrus_cytrus_1emu_NativeLibrary_getPerfStats(JNIEnv* env,
                                                                    [[maybe_unused]] jobject obj) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_run__Ljava_lang_String_2(
    ...
    const Core::System::ResultStatus result{RunCytrus(path)};
    if (result != Core::System::ResultStatus::Success) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_reloadCameraDevices([[maybe_unused]] JNIEnv* env,
                                                                   [[maybe_unused]] jobject obj) {
    if (g_ndk_factory) {
...
jboolean Java_org_cytrus_cytrus_1emu_NativeLibrary_loadAmiibo(JNIEnv* env,
                                                              [[maybe_unused]] jobject obj,
                                                              jstring j_file) {
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_removeAmiibo([[maybe_unused]] JNIEnv* env,
                                                            [[maybe_unused]] jobject obj) {
    Core::System& system{Core::System::GetInstance()};
    Service::SM::ServiceManager& sm = system.ServiceManager();
    auto nfc = sm.GetService<Service::NFC::Module::Interface>("nfc:u");
...
JNIEXPORT jobject JNICALL Java_org_cytrus_cytrus_1emu_utils_CiaInstallWorker_installCIA(
...
jobjectArray Java_org_cytrus_cytrus_1emu_NativeLibrary_getSavestateInfo(
...
void Java_org_cytrus_cytrus_1emu_NativeLibrary_saveState([[maybe_unused]] JNIEnv* env,
                                                         [[maybe_unused]] jobject obj, jint slot) {
    Core::System::GetInstance().SendSignal(Core::System::Signal::Save, slot);
}

void Java_org_cytrus_cytrus_1emu_NativeLibrary_loadState([[maybe_unused]] JNIEnv* env,
                                                         [[maybe_unused]] jobject obj, jint slot) {
    Core::System::GetInstance().SendSignal(Core::System::Signal::Load, slot);
}

void Java_org_cytrus_cytrus_1emu_NativeLibrary_logDeviceInfo([[maybe_unused]] JNIEnv* env,
                                                             [[maybe_unused]] jobject obj) {
