...
class GamesViewModel : ViewModel() {
    ...
    init {
        ...
        val storedGames = PreferenceManager.getDefaultSharedPreferences(CytrusApplication.appContext)
        ...
        if (storedGames!!.isNotEmpty()) {
            ...
            storedGames.forEach {
                ...
                val gameExists =
                    DocumentFile.fromSingleUri(CytrusApplication.appContext, Uri.parse(game.path))
                        ?.exists()
                if (gameExists == true) {
