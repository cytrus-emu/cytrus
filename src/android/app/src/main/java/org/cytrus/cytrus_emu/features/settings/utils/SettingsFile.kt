...
package org.cytrus.cytrus_emu.features.settings.utils
...
import org.cytrus.cytrus_emu.features.settings.model.SettingSection
import org.cytrus.cytrus_emu.features.settings.model.Settings.SettingsSectionMap
import org.cytrus.cytrus_emu.features.settings.model.StringSetting
import org.cytrus.cytrus_emu.features.settings.ui.SettingsActivityView
import org.cytrus.cytrus_emu.utils.BiMap
import org.cytrus.cytrus_emu.utils.DirectoryInitialization.userDirectory
...
object SettingsFile {
    ...
    fun readFile(
        ...
        try {
            val context: Context = CytrusApplication.appContext
    ...
    fun getSettingsFile(fileName: String): DocumentFile {
        val root = DocumentFile.fromTreeUri(CytrusApplication.appContext, Uri.parse(userDirectory))
