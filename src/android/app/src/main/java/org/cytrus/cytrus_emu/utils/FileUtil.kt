...
import org.cytrus.cytrus_emu.model.CheapDocument
...
object FileUtil {
    ...
    fun DocumentFile.inputStream(): InputStream =
        CytrusApplication.appContext.contentResolver.openInputStream(uri)!!

    fun DocumentFile.outputStream(): OutputStream =
        CytrusApplication.appContext.contentResolver.openOutputStream(uri)!!

    fun Uri.inputStream(): InputStream =
        CytrusApplication.appContext.contentResolver.openInputStream(this)!!

    fun Uri.outputStream(): OutputStream =
        CytrusApplication.appContext.contentResolver.openOutputStream(this)!!

    fun Uri.asDocumentFile(): DocumentFile? =
        DocumentFile.fromSingleUri(CytrusApplication.appContext, this)
