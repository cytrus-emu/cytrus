...
import org.cytrus.cytrus_emu.databinding.ActivitySettingsBinding
...
class SettingsActivity : AppCompatActivity(), SettingsActivityView {
    ...
    fun onSettingsReset() {
        ...
        val editor =
            PreferenceManager.getDefaultSharedPreferences(CytrusApplication.appContext).edit()
        ...
        if (DirectoryInitialization.setCytrusUserDirectory()) {
            CytrusApplication.documentsTree.setRoot(Uri.parse(DirectoryInitialization.userPath))
            NativeLibrary.createConfigFile()
        } else {
            throw IllegalStateException("Cytrus directory unavailable when accessing config file!")
        }
