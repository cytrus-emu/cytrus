...
import org.cytrus.cytrus_emu.features.hotkeys.Hotkey
...
class InputBindingSetting(
    ...
    private val context: Context get() = CytrusApplication.appContext
    ...
    /**
     * Returns the Cytrus button code for the settings key.
     */
    ...
    companion object {
        ...
        /**
         * Returns the settings key for the specified Cytrus button code.
         */
