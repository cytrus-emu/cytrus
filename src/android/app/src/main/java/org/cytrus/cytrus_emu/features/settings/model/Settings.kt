...
package org.cytrus.cytrus_emu.features.settings.model
...
class Settings {
    ...
    private fun loadCytrusSettings(view: SettingsActivityView?) {
    ...
    fun saveSettings(view: SettingsActivityView) {
        if (TextUtils.isEmpty(gameId)) {
            view.showToastMessage(
                CytrusApplication.appContext.getString(R.string.ini_saved),
                false
            )
