...
import org.cytrus.cytrus_emu.ui.main.ThemeProvider
...
object ThemeUtil {
    ...
    fun setTheme(activity: AppCompatActivity) {
        ...
        if (preferences.getBoolean(Settings.PREF_MATERIAL_YOU, false)) {
            activity.setTheme(R.style.Theme_Cytrus_Main_MaterialYou)
        } else {
            activity.setTheme(R.style.Theme_Cytrus_Main)
        }
        ...
        if (preferences.getBoolean(Settings.PREF_BLACK_BACKGROUNDS, false) &&
            ...
            activity.setTheme(R.style.ThemeOverlay_Cytrus_Dark)
        }
    }
