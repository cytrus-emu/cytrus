...
import org.cytrus.cytrus_emu.EmulationNavigationDirections
import org.cytrus.cytrus_emu.NativeLibrary
import org.cytrus.cytrus_emu.R
import org.cytrus.cytrus_emu.activities.EmulationActivity
import org.cytrus.cytrus_emu.databinding.DialogCheckboxBinding
import org.cytrus.cytrus_emu.databinding.DialogSliderBinding
import org.cytrus.cytrus_emu.databinding.FragmentEmulationBinding
import org.cytrus.cytrus_emu.display.ScreenAdjustmentUtil
import org.cytrus.cytrus_emu.display.ScreenLayout
...
import org.cytrus.cytrus_emu.utils.DirectoryInitialization
import org.cytrus.cytrus_emu.utils.DirectoryInitialization.DirectoryInitializationState
import org.cytrus.cytrus_emu.utils.EmulationMenuSettings
import org.cytrus.cytrus_emu.utils.FileUtil
import org.cytrus.cytrus_emu.utils.GameHelper
import org.cytrus.cytrus_emu.utils.GameIconUtils
import org.cytrus.cytrus_emu.utils.EmulationLifecycleUtil
import org.cytrus.cytrus_emu.utils.Log
import org.cytrus.cytrus_emu.utils.ViewUtils
import org.cytrus.cytrus_emu.viewmodel.EmulationViewModel
...
class EmulationFragment : Fragment(), SurfaceHolder.Callback, Choreographer.FrameCallback {
    ...
    override fun onResume() {
        ...
        if (DirectoryInitialization.areCytrusDirectoriesReady()) {
            emulationState.run(emulationActivity.isActivityRecreated)
        } else {
            setupCytrusDirectoriesThenStartEmulation()
        }
    }
    ...
    private fun setupCytrusDirectoriesThenStartEmulation() {
    ...
    private fun showAdjustOpacityDialog() {
        ...
        sliderBinding.apply {
            slider.valueTo = 255f
            slider.value = preferences.getInt("controlOpacity", 255).toFloat()
            slider.addOnChangeListener(
                Slider.OnChangeListener { slider: Slider, progress: Float, _: Boolean ->
