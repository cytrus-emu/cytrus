...
import org.cytrus.cytrus_emu.utils.GpuDriverHelper
import org.cytrus.cytrus_emu.utils.Log
import org.cytrus.cytrus_emu.viewmodel.DriverViewModel
...
class HomeSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optionsList = listOf(
            ...
            HomeSetting(
                ...
                R.string.select_cytrus_user_folder_home_description,
                R.drawable.ic_home,
    ...
    private fun shareLog() {
        val logDirectory = DocumentFile.fromTreeUri(
            requireContext(),
            PermissionsHandler.cytrusDirectory
        )?.findFile("log")
        val currentLog = logDirectory?.findFile("cytrus_log.txt")
        val oldLog = logDirectory?.findFile("cytrus_log.txt.old.txt")
