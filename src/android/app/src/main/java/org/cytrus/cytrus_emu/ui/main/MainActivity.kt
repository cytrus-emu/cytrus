...
package org.cytrus.cytrus_emu.ui.main
...
import org.cytrus.cytrus_emu.contracts.OpenFileResultContract
import org.cytrus.cytrus_emu.databinding.ActivityMainBinding
...
import org.cytrus.cytrus_emu.fragments.SelectUserDirectoryDialogFragment
import org.cytrus.cytrus_emu.utils.CiaInstallWorker
import org.cytrus.cytrus_emu.utils.CytrusDirectoryHelper
import org.cytrus.cytrus_emu.utils.DirectoryInitialization
import org.cytrus.cytrus_emu.utils.FileBrowserHelper
import org.cytrus.cytrus_emu.utils.InsetsHelper
import org.cytrus.cytrus_emu.utils.PermissionsHandler
import org.cytrus.cytrus_emu.utils.ThemeUtil
import org.cytrus.cytrus_emu.viewmodel.GamesViewModel
...
class MainActivity : AppCompatActivity(), ThemeProvider {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        splashScreen.setKeepOnScreenCondition {
            !DirectoryInitialization.areCytrusDirectoriesReady() &&
    ...
    val openCytrusDirectory = registerForActivityResult(ActivityResultContracts.OpenDocumentTree()) { result: Uri? ->
        if (result == null) {
            return@registerForActivityResult
        }

        CytrusDirectoryHelper(this@MainActivity).showCytrusDirectoryDialog(result)
    }
