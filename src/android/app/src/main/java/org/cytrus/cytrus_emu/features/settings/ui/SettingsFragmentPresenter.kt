...
import org.cytrus.cytrus_emu.features.settings.model.view.HeaderSetting
...
import org.cytrus.cytrus_emu.fragments.ResetSettingsDialogFragment
import org.cytrus.cytrus_emu.utils.BirthdayMonth
...
class SettingsFragmentPresenter(private val fragmentView: SettingsFragmentView) {
    ...
    fun onViewCreated(settingsAdapter: SettingsAdapter) {
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(CytrusApplication.appContext)
        loadSettingsList()
    }
    ...
    private fun addSystemSettings(sl: ArrayList<SettingsItem>) {
        ...
        sl.apply {
            val usernameSetting = object : AbstractStringSetting {
                ...
                override val defaultValue = "CYTRUS"
            }
            add(
                StringInputSetting(
                    usernameSetting,
