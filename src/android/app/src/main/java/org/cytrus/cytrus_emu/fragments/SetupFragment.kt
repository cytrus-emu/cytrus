...
import org.cytrus.cytrus_emu.adapters.SetupAdapter
import org.cytrus.cytrus_emu.databinding.FragmentSetupBinding
import org.cytrus.cytrus_emu.features.settings.model.Settings
import org.cytrus.cytrus_emu.model.SetupCallback
import org.cytrus.cytrus_emu.model.SetupPage
import org.cytrus.cytrus_emu.model.StepState
...
class SetupFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pages.apply {
            ...
            add(
                SetupPage(
                    R.drawable.ic_home,
                    R.string.select_cytrus_user_folder,
                    R.string.select_cytrus_user_folder_description,
                    0,
                    true,
                    R.string.select,
                    {
                        userDirCallback = it
                        openCytrusDirectory.launch(null)
                    },
                    true,
                    true,
                    {
    ...
    private val openCytrusDirectory = registerForActivityResult<Uri, Uri>(
        ...
        CytrusDirectoryHelper(requireActivity()).showCytrusDirectoryDialog(result, userDirCallback)
    }
