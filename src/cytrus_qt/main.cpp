...
#include "cytrus_qt/aboutdialog.h"
#include "cytrus_qt/applets/mii_selector.h"
#include "cytrus_qt/applets/swkbd.h"
#include "cytrus_qt/bootmanager.h"
#include "cytrus_qt/camera/qt_multimedia_camera.h"
#include "cytrus_qt/camera/still_image_camera.h"
#include "cytrus_qt/compatdb.h"
#include "cytrus_qt/compatibility_list.h"
#include "cytrus_qt/configuration/config.h"
#include "cytrus_qt/configuration/configure_dialog.h"
#include "cytrus_qt/configuration/configure_per_game.h"
#include "cytrus_qt/debugger/console.h"
#include "cytrus_qt/debugger/graphics/graphics.h"
#include "cytrus_qt/debugger/graphics/graphics_breakpoints.h"
#include "cytrus_qt/debugger/graphics/graphics_cmdlists.h"
#include "cytrus_qt/debugger/graphics/graphics_surface.h"
#include "cytrus_qt/debugger/graphics/graphics_tracing.h"
#include "cytrus_qt/debugger/graphics/graphics_vertex_shader.h"
#include "cytrus_qt/debugger/ipc/recorder.h"
#include "cytrus_qt/debugger/lle_service_modules.h"
#include "cytrus_qt/debugger/profiler.h"
#include "cytrus_qt/debugger/registers.h"
#include "cytrus_qt/debugger/wait_tree.h"
#include "cytrus_qt/discord.h"
#include "cytrus_qt/dumping/dumping_dialog.h"
#include "cytrus_qt/game_list.h"
#include "cytrus_qt/hotkeys.h"
#include "cytrus_qt/loading_screen.h"
#include "cytrus_qt/main.h"
#include "cytrus_qt/movie/movie_play_dialog.h"
#include "cytrus_qt/movie/movie_record_dialog.h"
#include "cytrus_qt/multiplayer/state.h"
#include "cytrus_qt/qt_image_interface.h"
#include "cytrus_qt/uisettings.h"
#include "cytrus_qt/updater/updater.h"
#include "cytrus_qt/util/clickable_label.h"
#include "cytrus_qt/util/graphics_device_info.h"
...
void GMainWindow::ShowTelemetryCallout() {
    ...
    const QString telemetry_message =
        tr("<a href='https://cytrus-emu.org/entry/telemetry-and-why-thats-a-good-thing/'>Anonymous "
           "data is collected</a> to help improve Cytrus. "
...
GMainWindow::GMainWindow(Core::System& system_)
    ...
    LOG_INFO(Frontend, "Cytrus Version: {} | {}-{}", Common::g_build_fullname, Common::g_scm_branch,
             Common::g_scm_desc);
#if CYTRUS_ARCH(x86_64)
    ...
    if (gl_renderer.startsWith(QStringLiteral("D3D12"))) {
        ...
        // We can override the version here to allow Cytrus to work.
...
#ifdef CYTRUS_ENABLE_COMPATIBILITY_REPORTING
...
void GMainWindow::InitializeHotkeys() {
    ...
    link_action_shortcut(ui->action_Exit, QStringLiteral("Exit Cytrus"));
...
void GMainWindow::ConnectMenuEvents() {
    ...
    connect_menu(ui->action_About, &GMainWindow::OnMenuAboutCytrus);
...
static std::optional<QDBusObjectPath> HoldWakeLockLinux(u32 window_id = 0) {
    ...
    QVariantMap options = {};
    //: TRANSLATORS: This string is shown to the user to explain why Cytrus needs to prevent the
    //: computer from sleeping
    options.insert(QString::fromLatin1("reason"),
                   QCoreApplication::translate("GMainWindow", "Cytrus is running a game"));
    ...
    if (result != Core::System::ResultStatus::Success) {
        ...
        case Core::System::ResultStatus::ErrorGetLoader:
            ...
            QMessageBox::critical(
                ...
                tr("Your ROM format is not supported.<br/>Please follow the guides to redump your "
                   "<a href='https://cytrus-emu.org/wiki/dumping-game-cartridges/'>game "
                   "cartridges</a> or "
                   "<a href='https://cytrus-emu.org/wiki/dumping-installed-titles/'>installed "
                   "titles</a>."));
            break;
        ...
        case Core::System::ResultStatus::ErrorLoader_ErrorGbaTitle:
            QMessageBox::critical(this, tr("Unsupported ROM"),
                                  tr("GBA Virtual Console ROMs are not supported by Cytrus."));
            break;
...
void GMainWindow::BootGame(const QString& filename) {
    ...
    LOG_INFO(Frontend, "Cytrus starting...");
...
void GMainWindow::OnGameListNavigateToGamedbEntry(u64 program_id,
    ...
    QDesktopServices::openUrl(QUrl(QStringLiteral("https://cytrus-emu.org/game/") + directory));
}
    ...
    case Service::AM::InstallStatus::ErrorEncrypted:
        QMessageBox::critical(this, tr("Encrypted File"),
                              tr("%1 must be decrypted "
                                 "before being used with Cytrus. A real 3DS is required.")
                                  .arg(filename));
        break;
...
void GMainWindow::UninstallTitles(
    ...
    if (failed) {
        QMessageBox::critical(this, tr("Cytrus"), tr("Failed to uninstall '%1'.").arg(failed_name));
    } else if (!future_watcher.isCanceled()) {
        QMessageBox::information(this, tr("Cytrus"),
...
void GMainWindow::OnMenuReportCompatibility() {
    if (!NetSettings::values.cytrus_token.empty() && !NetSettings::values.cytrus_username.empty()) {
        CompatDB compatdb{system.TelemetrySession(), this};
        compatdb.exec();
    } else {
        QMessageBox::critical(this, tr("Missing Cytrus Account"),
                              tr("You must link your Cytrus account to submit test cases."
...
void GMainWindow::OnOpenCytrusFolder() {
    ...
    if (DynamicLibrary::FFmpeg::LoadFFmpeg()) {
...
#ifdef _WIN32
               "\n\nTo install FFmpeg to Cytrus, press Open and select your FFmpeg directory."
#endif
        ...
        if (result == QMessageBox::Help) {
            QDesktopServices::openUrl(QUrl(QStringLiteral(
                "https://cytrus-emu.org/wiki/installing-ffmpeg-for-the-video-dumper/")));
#ifdef _WIN32
...
void GMainWindow::OnOpenFFmpeg() {
    ...
    for (auto& library_name : library_names) {
        if (!FileUtil::Exists(bin_dir + DIR_SEP + library_name)) {
            QMessageBox::critical(this, tr("Cytrus"),
    ...
    if (success.load()) {
        QMessageBox::information(this, tr("Cytrus"), tr("FFmpeg has been sucessfully installed."));
    } else {
        QMessageBox::critical(this, tr("Cytrus"),
    ...
    if (result == Core::System::ResultStatus::ErrorSystemFiles) {
        const QString common_message =
            tr("%1 is missing. Please <a "
               "href='https://cytrus-emu.org/wiki/"
        ...
        message =
            tr("A fatal error occurred. "
               "<a href='https://community.cytrus-emu.org/t/how-to-upload-the-log-file/296'>Check "
...
void GMainWindow::OnMenuAboutCytrus() {
...
bool GMainWindow::ConfirmClose() {
    ...
    QMessageBox::StandardButton answer =
        QMessageBox::question(this, tr("Cytrus"), tr("Would you like to exit now?"),
...
bool GMainWindow::ConfirmChangeGame() {
    ...
    auto answer = QMessageBox::question(
        this, tr("Cytrus"), tr("The game is still running. Would you like to stop emulation?"),
        QMessageBox::Yes | QMessageBox::No, QMessageBox::No);
    return answer != QMessageBox::No;
}
...
void GMainWindow::UpdateWindowTitle() {
    ...
    if (game_title.isEmpty()) {
        setWindowTitle(QStringLiteral("Cytrus %1").arg(full_name));
    } else {
        setWindowTitle(QStringLiteral("Cytrus %1 | %2").arg(full_name, game_title));
        render_window->setWindowTitle(
            QStringLiteral("Cytrus %1 | %2 | %3").arg(full_name, game_title, tr("Primary Window")));
        secondary_window->setWindowTitle(QStringLiteral("Cytrus %1 | %2 | %3")
...
int main(int argc, char* argv[]) {
    ...
    QCoreApplication::setOrganizationName(QStringLiteral("Cytrus team"));
    QCoreApplication::setApplicationName(QStringLiteral("Cytrus"));
