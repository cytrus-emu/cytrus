...
const std::array<UISettings::Shortcut, 35> Config::default_hotkeys {{
     ...
     {QStringLiteral("Exit Cytrus"),               QStringLiteral("Main Window"), {QStringLiteral("Ctrl+Q"), Qt::WindowShortcut}},
...
void Config::ReadWebServiceValues() {
    ...
    NetSettings::values.web_api_url =
        ReadSetting(QStringLiteral("web_api_url"), QStringLiteral("https://api.cytrus-emu.org"))
            .toString()
            .toStdString();
    NetSettings::values.cytrus_username =
        ReadSetting(QStringLiteral("cytrus_username")).toString().toStdString();
    NetSettings::values.cytrus_token =
        ReadSetting(QStringLiteral("cytrus_token")).toString().toStdString();
...
void Config::SaveWebServiceValues() {
    ...
    WriteSetting(QStringLiteral("web_api_url"),
                 ...
                 QStringLiteral("https://api.cytrus-emu.org"));
    WriteSetting(QStringLiteral("cytrus_username"),
                 QString::fromStdString(NetSettings::values.cytrus_username));
    WriteSetting(QStringLiteral("cytrus_token"),
                 QString::fromStdString(NetSettings::values.cytrus_token));
