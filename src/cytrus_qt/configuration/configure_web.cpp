...
void ConfigureWeb::SetConfiguration() {
    ...
    ui->telemetry_learn_more->setText(tr("<a "
                                         "href='https://cytrus-emu.org/entry/"
    ...
    ui->web_signup_link->setText(
        tr("<a href='https://profile.cytrus-emu.org/'><span style=\"text-decoration: underline; "
           "color:#039be5;\">Sign up</span></a>"));
    ui->web_token_info_link->setOpenExternalLinks(true);
    ui->web_token_info_link->setText(tr(
        "<a href='https://cytrus-emu.org/wiki/cytrus-web-service/'><span style=\"text-decoration: "
    ...
    ui->edit_token->setText(QString::fromStdString(GenerateDisplayToken(
        NetSettings::values.cytrus_username, NetSettings::values.cytrus_token)));
