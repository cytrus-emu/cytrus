...
#include "cytrus_qt/configuration/configure_motion_touch.h"
#include "cytrus_qt/configuration/configure_touch_from_button.h"
...
bool ConfigureMotionTouch::CanCloseDialog() {
    if (udp_test_in_progress) {
        QMessageBox::warning(this, tr("Cytrus"),
