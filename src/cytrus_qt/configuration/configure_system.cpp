...
#include "cytrus_qt/configuration/configuration_shared.h"
...
ConfigureSystem::ConfigureSystem(Core::System& system_, QWidget* parent)
    ...
    if (keys_available) {
        ...
        ui->label_nus_download->setText(
            tr("Cytrus is missing keys to download system files. <br><a "
               "href='https://cytrus-emu.org/wiki/aes-keys/'><span style=\"text-decoration: "
...
void ConfigureSystem::DownloadFromNUS() {
    ...
    if (failed) {
        QMessageBox::critical(this, tr("Cytrus"), tr("Downloading system files failed."));
    } else if (!future_watcher.isCanceled()) {
        QMessageBox::information(this, tr("Cytrus"), tr("Successfully downloaded system files."));
    }
